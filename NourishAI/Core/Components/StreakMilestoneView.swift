// NourishAI — StreakMilestoneView.swift
import SwiftUI
...
struct StreakMilestoneView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    Text("\(milestone)-Day Streak!")
                        .font(NourishTheme.Font.title(28))
            ...
            .padding(NourishTheme.Spacing.xl)
...
private struct ConfettiPiece: Identifiable {
    ...
    init() {
        color = [Color.orange, .yellow, NourishTheme.Color.primary, .pink, .purple, .cyan].randomElement()!
