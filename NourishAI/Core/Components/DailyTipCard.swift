...
struct DailyTipCard: View {
    ...
    private static let tips: [(icon: String, text: String, color: Color)] = [
        ...
        ("leaf.fill",        "Eating a rainbow of vegetables ensures a wide variety of antioxidants and micronutrients.", NourishTheme.Color.primary),
        ...
        ("figure.walk",      "A 10-minute walk after meals can lower post-meal blood sugar by 22%.", NourishTheme.Color.primary),
        ...
        ("hand.raised.fill", "Processed foods high in ultra-processed ingredients can displace nutritious whole foods — aim for 80/20.", NourishTheme.Color.primary),
        ...
        ("globe.americas.fill", "Mediterranean and MIND diets consistently rank as the most evidence-backed eating patterns for longevity.", NourishTheme.Color.primary),
