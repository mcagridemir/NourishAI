// NourishAI — LiveActivityService.swift
import ActivityKit
import Foundation
...
final class LiveActivityService {
    ...
    private var currentActivity: Activity<NourishActivityAttributes>?
    ...
    func startOrUpdate(user: User) {
        ...
        if let activity = currentActivity {
            ...
            let attrs = NourishActivityAttributes(userName: user.name)
    ...
    private func makeState(for user: User) -> NourishActivityAttributes.ContentState {
