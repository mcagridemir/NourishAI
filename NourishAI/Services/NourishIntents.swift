// NourishAI — NourishIntents.swift
...
struct LogWaterIntent: AppIntent {
    ...
    static let description = IntentDescription("Log a water intake in NourishAI.")
    ...
    func perform() async throws -> some ProvidesDialog {
        ...
        return .result(dialog: "Logged \(ml) ml of water in NourishAI. 💧")
    }
}
...
struct CheckCaloriesIntent: AppIntent {
    ...
    static let description = IntentDescription("See how many calories you've logged today in NourishAI.")
    static let openAppWhenRun = false
...
struct CheckStreakIntent: AppIntent {
    ...
    static let description = IntentDescription("Check your current NourishAI logging streak.")
    static let openAppWhenRun = false
    ...
    func perform() async throws -> some ProvidesDialog {
        ...
        return .result(dialog: "Your current NourishAI streak is \(data.streak) days. Keep it up! 🔥")
    }
}

// MARK: - App Shortcuts (appear automatically in Siri & Shortcuts app)

struct NourishShortcuts: AppShortcutsProvider {
