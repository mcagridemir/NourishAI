// NourishAI — HydrationTrendView.swift
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                VStack(alignment: .trailing, spacing: 2) {
                    Text("\(goalHitDays)/7 days")
                        ...
                        .foregroundStyle(goalHitDays >= 5 ? NourishTheme.Color.primary : .orange)
                    Text("goal reached")
            ...
            HStack(spacing: 0) {
                ...
                }(), color: user.todayWaterMl >= user.dailyWaterGoalMl ? NourishTheme.Color.primary : .orange)
                Spacer()
