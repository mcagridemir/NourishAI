// NourishAI — DailyScoreCard.swift
...
struct DailyScoreCard: View {
    ...
    private var scoreColor: Color {
        ...
        case 60..<80: return NourishTheme.Color.primary
    ...
    private var pillars: [(label: String, icon: String, score: Int, color: Color)] {[
        ...
        ("Protein",    "bolt.fill",           proteinScore,  NourishTheme.Color.macro(.protein)),
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(alignment: .center, spacing: NourishTheme.Spacing.lg) {
                // Big ring
                ZStack {
                    Circle()
                    ...
                    Circle()
                        ...
                        .frame(width: 90, height: 90)
                        .animation(NourishTheme.Animation.slow, value: totalScore)
                    VStack(spacing: 0) {
                        Text("\(totalScore)")
            ...
            GeometryReader { geo in
                ZStack(alignment: .leading) {
                    ...
                    RoundedRectangle(cornerRadius: 3)
                        ...
                        .animation(NourishTheme.Animation.smooth, value: p.score)
                }
            }
            .frame(height: 5)
            Text("\(p.score)")
