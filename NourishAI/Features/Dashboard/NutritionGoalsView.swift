// NourishAI — NutritionGoalsView.swift
        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: NourishTheme.Spacing.lg) {
                    ...
                    .padding(.top, NourishTheme.Spacing.md)
                    ...
                    GoalSection(title: "Macronutrients", icon: "chart.pie.fill") {
                        ...
                        GoalRow(label: "Protein",
                                ...
                                unit: "g",
                                color: NourishTheme.Color.macro(.protein))
                        GoalRow(label: "Carbohydrates",
                                value: carbs,
                                target: user.dailyCarbTarget,
                                unit: "g",
                                color: NourishTheme.Color.macro(.carbs))
                        GoalRow(label: "Fat",
                                value: fat,
                                target: user.dailyFatTarget,
                                unit: "g",
                                color: NourishTheme.Color.macro(.fat))
                        GoalRow(label: "Fiber",
                                value: fiber,
                                target: user.dailyFiberTarget,
                                unit: "g",
                                color: NourishTheme.Color.macro(.fiber))
                    }
