...
struct WhatsNewView: View {
    ...
    private let features: [(icon: String, color: Color, title: String, body: String)] = [
        ...
        ("arrow.left.arrow.right", NourishTheme.Color.primary, "Week-on-Week Comparison",
        ...
        ("paintpalette.fill",    .orange,  "App Themes",
         "Choose from 8 colour presets to personalise your NourishAI experience."),
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ForEach(features, id: \.title) { feature in
                            ...
                            if feature.title != features.last?.title {
                                Divider().padding(.leading, 68 + NourishTheme.Spacing.lg)
                            }
                        }
                    }
                    .padding(.bottom, 32)
